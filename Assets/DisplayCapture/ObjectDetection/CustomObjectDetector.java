...
public class CustomObjectDetector implements IDisplayCaptureReceiver {
    ...
    public static CustomObjectDetector instance = null;

    private final com.google.mlkit.vision.objects.ObjectDetector objectDetector; // Fully qualify the type here
    ...
    public static synchronized CustomObjectDetector getInstance() {
        if (instance == null)
            instance = new CustomObjectDetector();
